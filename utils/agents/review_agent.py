...
class ReviewAgent:
    ...
    def review_sources(self, original_question:str, documentation_sources:list[ChatContext], code_sources:list[ChatContext]):
        PROMPT = """
        ...
        response = chain.invoke({"question": original_question, "documentation_responses": documentation_sources, "code_responses": code_sources})
        return response
